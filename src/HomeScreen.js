...
import { View, Text, Image, ScrollView, RefreshControl, SafeAreaView, StyleSheet, Button} from "react-native";
      ...
      >
        <LinearGradient colors={bgColors} style={styles.container}>
          <View style={styles.container}>
            ...
            />
            <View>
              <Text style={styles.feel}>{current.description}</Text>
              ...
              <View style={styles.b1}>
                ...
                <Text style={styles.fl}>
                  {Math.round((forecast.main.feels_like - 273.15) * 100) / 100}
                  °C{"\n"}
                  Feels Like
                </Text>
              </View>
            ...
            <View>
              <Text style={styles.hf}>HOURLY FORECAST</Text>
            </View>
          ...
          <View>
            <Text style={styles.text_down}>Weather Application</Text>
